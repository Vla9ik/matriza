    ...
    (() => {
        ...
        function initSliders() {
            if (document.querySelector(".tabs__slider")) {
                const swiperTab = new swiper_core_Swiper(".tabs__slider", {
                    modules: [ Navigation ],
                    observer: true,
                    observeParents: true,
                    slidesPerView: 5,
...
***************************************************************************** */
        ...
        const certificates = document.querySelectorAll("#screenshot");
        certificates.forEach((screenshot => {
            lightgallery_es5(screenshot, {
                selector: "this",
                plugins: [ lg_zoom_min ],
        ...
        document.addEventListener("DOMContentLoaded", (function() {
            ...
            dateInputs.forEach((function(input) {
                input.addEventListener("input", (function(e) {
                    ...
                    if (value.length > 4) value = value.slice(0, 2) + "." + value.slice(2, 4) + "." + value.slice(4, 8); else if (value.length > 2) value = value.slice(0, 2) + "." + value.slice(2);
                    input.value = value;
                }));
